...
color_eee.nv12.fr.yuv:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined color_eee -o sources/color_eee.nv12.fr.yuv
...
color_eee.nv12.lr.yuv:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined color_eee -o sources/color_eee.nv12.lr.yuv
...
color_eee.yuv420p.fr.yuv:
	./yuvgrad.py --pix_fmt yuv420p --range full --predefined color_eee -o sources/color_eee.yuv420p.fr.yuv
...
color_eee.yuv420p.lr.yuv:
	./yuvgrad.py --pix_fmt yuv420p --range limited --predefined color_eee -o sources/color_eee.yuv420p.lr.yuv
...
# color
color.nv12.fr.yuv:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined color -o sources/color.nv12.fr.yuv
...
color.nv12.lr.yuv:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined color -o sources/color.nv12.lr.yuv
...
color.yuv420p.fr.yuv:
	./yuvgrad.py --pix_fmt yuv420p --range full --predefined color -o sources/color.yuv420p.fr.yuv
...
color.yuv420p.lr.yuv:
	./yuvgrad.py --pix_fmt yuv420p --range limited --predefined color -o sources/color.yuv420p.lr.yuv
...
# gray
gray.nv12.fr.yuv:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined gray -o sources/gray.nv12.fr.yuv
...
gray.nv12.lr.yuv:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined gray -o sources/gray.nv12.lr.yuv
...
gray.yuv420p.fr.yuv:
	./yuvgrad.py --pix_fmt yuv420p --range full --predefined gray -o sources/gray.yuv420p.fr.yuv
...
gray.yuv420p.lr.yuv:
	./yuvgrad.py --pix_fmt yuv420p --range limited --predefined gray -o sources/gray.yuv420p.lr.yuv
...
# hdtv.y
hdtv.y.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined hdtv.y -o sources/hdtv.y.fr.nv12
...
hdtv.y.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined hdtv.y -o sources/hdtv.y.lr.nv12
...
# hdtv.u
hdtv.u.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined hdtv.u -o sources/hdtv.u.fr.nv12
...
hdtv.u.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined hdtv.u -o sources/hdtv.u.lr.nv12
...
# hdtv.v
hdtv.v.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined hdtv.v -o sources/hdtv.v.fr.nv12
...
hdtv.v.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined hdtv.v -o sources/hdtv.v.lr.nv12
...
# hdtv.uv
hdtv.uv.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined hdtv.uv -o sources/hdtv.uv.fr.nv12
...
hdtv.uv.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined hdtv.uv -o sources/hdtv.uv.lr.nv12
...
# sdtv.y
sdtv.y.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined sdtv.y -o sources/sdtv.y.fr.nv12
...
sdtv.y.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined sdtv.y -o sources/sdtv.y.lr.nv12
...
# sdtv.u
sdtv.u.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined sdtv.u -o sources/sdtv.u.fr.nv12
...
sdtv.u.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined sdtv.u -o sources/sdtv.u.lr.nv12
...
# sdtv.v
sdtv.v.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined sdtv.v -o sources/sdtv.v.fr.nv12
...
sdtv.v.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined sdtv.v -o sources/sdtv.v.lr.nv12
...
# sdtv.uv
sdtv.uv.fr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range full --predefined sdtv.uv -o sources/sdtv.uv.fr.nv12
...
sdtv.uv.lr.nv12:
	./yuvgrad.py --pix_fmt nv12 --range limited --predefined sdtv.uv -o sources/sdtv.uv.lr.nv12
