...
TEST_LIST = [
    [16, 4, 'E', 10, 19, 'S', 0, 255, 'N', 127, 127, 'yuv420p', """
    ...
    """],
    [16, 4, 'E', 10, 19, 'S', 0, 255, 'N', 127, 127, 'nv12', """
        0a0a 0b0b 0c0d 0d0e 0e0f 1010 1111 1213
        0a0a 0b0b 0c0d 0d0e 0e0f 1010 1111 1213
        0a0a 0b0b 0c0d 0d0e 0e0f 1010 1111 1213
        0a0a 0b0b 0c0d 0d0e 0e0f 1010 1111 1213
...
class GenerateGradientFileTestCase(unittest.TestCase):
    def testList(self):
        """Test TEST_LIST"""
        for (width, height, ygrad, ymin, ymax, ugrad, umin, umax,
             vgrad, vmin, vmax, pix_fmt, cont) in TEST_LIST:
            fout = io.BytesIO()
            yuvgrad.generate_gradient_file(fout, width, height,
                                           ygrad, ymin, ymax,
                                           ugrad, umin, umax,
                                           vgrad, vmin, vmax,
                                           pix_fmt)
