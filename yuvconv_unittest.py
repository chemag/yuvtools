    ...
    def testList(self):
        ...
        for (
            ...
            odata = yuvconv.convert_image(
                idata, width, height, ipix_fmt, conversion_name, opix_fmt
            )
            ...
            self.assertEqual(
                expected_odata, odata, "%s (%s)" % (test_name, conversion_name)
            )
            i += 1
